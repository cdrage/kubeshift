...
import tempfile
import os
from kubeshift.exceptions import ProviderFailedException
...
class TestKubeConfParsing(unittest.TestCase):
    ...
    def test_parse_kubeconf_from_file(self):
        ...
        Config.parse_kubeconf(example_kubeconfig)
    ...
    def test_parse_kubeconf_data_insecure(self):
        ...
        self.assertEqual(Config.parse_kubeconf_data(kubecfg_data),
